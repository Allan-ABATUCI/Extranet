...
<div class="composante-container">
    <form action="?controller=<?= $_GET['controller'] ?>&action=maj_infos_composante&id=<?= $_GET['id'] ?>" method="post">
        <div class="infos-composante">
            ...
            <div class="form-address">
                ...
                <input type="text" placeholder="<?= $infos['nom_voie'] ?>" name="nom-voie" class="input-case form-nom-voie">
            </div>
            <div class="form-address">
    ...
    <div class="infos-container">
        <div class="infos__colonne">
            ...
            <a href="?controller=<?= $_GET['controller'] ?>&action=ajout_interlocuteur_form&id=<?= $_GET['id'] ?>" class="ajout"><i class="fa fa-solid fa-user-plus"></i> &nbsp; Ajouter</a>
        ...
        <div class="infos__colonne">
            ...
            <?php if (!str_contains($_GET['controller'], 'commercial')) : ?>
                ...
                <a href="?controller=<?= $_GET['controller'] ?>&action=ajout_prestataire_form&id=<?= $_GET['id'] ?>" class="ajout"><i class="fa fa-solid fa-user-plus"></i> &nbsp; Ajouter</a>
            <?php else : ?>
                <a class="ajout"> &nbsp;</a>
            <?php endif; ?>
        ...
        <div class="infos__colonne">
            ...
            <?php foreach ($bdl as $b) : ?>
                <a href="?controller=<?= $_GET['controller'] ?>&action=consulter_bdl&annee=<?= $b['annee'] ?>&mois=<?= $b['mois'] ?>" class="block">
